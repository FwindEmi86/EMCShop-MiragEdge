...
public final class ContainerStorage {
    ...
    public static void setItemID(ItemStack i, EMCShopMiragEdge plugin, String string) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_ID);
        setData(i, key, string);
    }

    @Nullable
    public static String getItemID(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_ID);
        return getDataString(i, key);
    }

    public static boolean isTransmutationOrb(ItemStack i, EMCShopMiragEdge plugin) {
    ...
    public static void makeTransmutationOrb(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_TRANSMUTATION_ORB);
        setData(i, key, 1);
    }

    public static boolean isCraftable(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_CRAFTING);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeCraftable(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_CRAFTING);
        setData(i, key, 1);
    }

    public static boolean isAlchemicalCoal(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_COAL_1);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeAlchemicalCoal(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_COAL_1);
        setData(i, key, 1);
    }

    public static boolean isMobiusFuel(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_COAL_2);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeMobiusFuel(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_COAL_2);
        setData(i, key, 1);
    }

    public static boolean isAeternalisFuel(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_COAL_3);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeAeternalisFuel(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_COAL_3);
        setData(i, key, 1);
    }

    public static boolean isDarkMatter(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_DRK);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeDarkMatter(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_DRK);
        setData(i, key, 1);
    }

    public static boolean isRedMatter(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_RED);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeRedMatter(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_RED);
        setData(i, key, 1);
    }

    public static boolean isDisChest(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_DISCST);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeDisChest(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_DISCST);
        setData(i, key, 1);
    }

    public static boolean isConChest(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_CONCST);
        return containerHasData(i, key, PersistentDataType.INTEGER);
    }

    public static void makeConChest(ItemStack i, EMCShopMiragEdge plugin) {
        NamespacedKey key = new NamespacedKey(plugin.getInstance(), CS_IS_CONCST);
        setData(i, key, 1);
    }
